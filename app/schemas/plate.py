...
class PlateBase(BaseModel):
    ...
    is_available: bool = Field(True, description="Whether the plate is currently available")
    category_id: int = Field(..., description="ID of the category this plate belongs to")
    ingredients: Optional[List[str]] = Field(None, description="List of ingredients in the plate")
...
class PlateUpdate(BaseModel):
    ...
    is_available: Optional[bool] = Field(None, description="Whether the plate is currently available")
    category_id: Optional[int] = Field(None, description="ID of the category this plate belongs to")
    ingredients: Optional[List[str]] = Field(None, description="List of ingredients in the plate")
